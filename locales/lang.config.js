...
const knowledgesReactCard = document.getElementById("knowledges-react-card");
...
const knowledgesReactText = document.getElementById("knowledges-react-text");
...
btnSwitcher.addEventListener("click", () => {
    ...
    knowledgesReactCard.setAttribute("title", languages[currentLanguage].sectionKnowledges.react.altTitle);
    ...
    knowledgesReactText.innerHTML = languages[currentLanguage].sectionKnowledges.react.text;
